// elm-watch hot {"version":"1.1.1","targetName":"My target name","webSocketPort":50423}
"use strict";
(() => {
...
var $author$project$Batch$OneCycle = {$: 'OneCycle'};
var $author$project$Batch$SixtyDays = {$: 'SixtyDays'};
var $author$project$Batch$ThreeMonths = {$: 'ThreeMonths'};
...
var $author$project$Main$init = {
	count: 1,
	currentMonth: $elm$time$Time$Jan,
	currentYear: 2023,
	events: _List_Nil,
	name: '',
	selling: $author$project$Batch$ThreeMonths,
	tuppingDate: A3($justinmimbs$date$Date$fromCalendarDate, 2023, $elm$time$Time$Jan, 15),
	tuppingDuration: $author$project$Batch$OneCycle,
	weaning: $author$project$Batch$SixtyDays
};
...
var $author$project$Batch$Batch = function (a) {
	return {$: 'Batch', a: a};
};
var $author$project$Batch$make = function (_v0) {
	var name = _v0.name;
	var ewesCount = _v0.ewesCount;
	var tuppingDate = _v0.tuppingDate;
	var tuppingDuration = _v0.tuppingDuration;
	var weaning = _v0.weaning;
	var selling = _v0.selling;
	return $author$project$Batch$Batch(
		{
			ewesCount: ewesCount,
			name: name,
			selling: selling,
			tupping: {date: tuppingDate, duration: tuppingDuration},
			weaning: weaning
		});
};
...
var $author$project$Batch$f = function (_v0) {
	...
	return A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, days, date);
};
...
var $author$project$Batch$run = function (_v0) {
	var tupping = _v0.a.tupping;
	var weaning = _v0.a.weaning;
	var selling = _v0.a.selling;
	return _List_fromArray(
		[
			{
			date: A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, -30, tupping.date),
			description: 'Augmentation des besoins en alimentation'
		},
			{
			date: A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, -16, tupping.date),
			description: 'Béliers vasomectisés'
		},
			{date: tupping.date, description: 'Mise en lutte'},
			{
			date: $author$project$Batch$f(tupping),
			...
			{
			date: A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, 120, tupping.date),
			description: 'Augmentation des besoins en alimentation'
		},
			{
			date: A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, 180, tupping.date),
			...
			{
			date: A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, 180 + 35, tupping.date),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DidChangeTuppingDuration':
				var tuppingDuration = msg.a;
				return _Utils_update(
					model,
					{tuppingDuration: tuppingDuration});
			case 'DidInputTuppingDate':
				return model;
			case 'DidInputWeaning':
				var weaning = msg.a;
				return _Utils_update(
					model,
					{weaning: weaning});
			case 'DidInputSelling':
				var selling = msg.a;
				return _Utils_update(
					model,
					{selling: selling});
			case 'DidChangeTuppingDate':
				var date = msg.a;
				return _Utils_update(
					model,
					{tuppingDate: date});
			case 'ClickedPreviousMonth':
				var previous = A3(
					...
					$justinmimbs$date$Date$Months,
					-1,
					A3($justinmimbs$date$Date$fromCalendarDate, model.currentYear, model.currentMonth, 1));
				return _Utils_update(
					model,
					{
						currentMonth: $justinmimbs$date$Date$month(previous),
						currentYear: $justinmimbs$date$Date$year(previous)
					});
			case 'ClickedNextMonth':
				var next = A3(
					$justinmimbs$date$Date$add,
					$justinmimbs$date$Date$Months,
					1,
				...
				return _Utils_update(
					model,
					{
						currentMonth: $justinmimbs$date$Date$month(next),
						currentYear: $justinmimbs$date$Date$year(next)
					});
			default:
				return _Utils_update(
					model,
					{
						events: $author$project$Batch$run(
							$author$project$Batch$make(
								{ewesCount: model.count, name: model.name, selling: model.selling, tuppingDate: model.tuppingDate, tuppingDuration: model.tuppingDuration, weaning: model.weaning}))
					});
		}
	});
var $author$project$Main$ClickedGenerate = {$: 'ClickedGenerate'};
var $author$project$Main$ClickedNextMonth = {$: 'ClickedNextMonth'};
var $author$project$Main$ClickedPreviousMonth = {$: 'ClickedPreviousMonth'};
var $author$project$Main$DidChangeTuppingDate = function (a) {
	return {$: 'DidChangeTuppingDate', a: a};
};
var $author$project$Main$DidChangeTuppingDuration = function (a) {
	return {$: 'DidChangeTuppingDuration', a: a};
};
var $author$project$Main$DidInputCount = function (a) {
	return {$: 'DidInputCount', a: a};
};
var $author$project$Main$DidInputName = function (a) {
	return {$: 'DidInputName', a: a};
};
var $author$project$Main$DidInputSelling = function (a) {
	return {$: 'DidInputSelling', a: a};
};
var $author$project$Main$DidInputWeaning = function (a) {
	return {$: 'DidInputWeaning', a: a};
};
var $author$project$Batch$EightMonths = {$: 'EightMonths'};
var $author$project$Batch$EightyDays = {$: 'EightyDays'};
var $author$project$Batch$FiveMonths = {$: 'FiveMonths'};
var $author$project$Batch$FourMonths = {$: 'FourMonths'};
var $author$project$Batch$NinetyDays = {$: 'NinetyDays'};
var $author$project$Batch$OneCycleAndAHalf = {$: 'OneCycleAndAHalf'};
var $author$project$Batch$SevenMonths = {$: 'SevenMonths'};
var $author$project$Batch$SeventyDays = {$: 'SeventyDays'};
var $author$project$Batch$SixMonths = {$: 'SixMonths'};
var $author$project$Batch$ThreeCycles = {$: 'ThreeCycles'};
var $author$project$Batch$TwoCycles = {$: 'TwoCycles'};
	...
	function (currentDay, day, msg) {
		var element = A2(
			...
			_Utils_ap(
				...
				_Utils_eq(
					A2($justinmimbs$date$Date$compare, day, currentDay),
					$elm$core$Basics$EQ) ? _List_fromArray(
					[
				...
				[
					...
					A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerY]),
						$mdgriffith$elm_ui$Element$text(
							$author$project$Language$fr.monthName(month) + (' ' + $elm$core$String$fromInt(year))))),
	...
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
			$mdgriffith$elm_ui$Element$text(
				$author$project$Language$fr.weekdayNameShort(weekday))));
};
...
var $author$project$Calendar$calendar = function (_v0) {
	...
	var currentDate = _v0.currentDate;
	var onSelectDay = _v0.onSelectDay;
	var onClickPreviousMonth = _v0.onClickPreviousMonth;
	var onClickNextMonth = _v0.onClickNextMonth;
	var firstDayOfTheMonth = A3($justinmimbs$date$Date$fromCalendarDate, currentYear, currentMonth, 1);
	var firstDayOfNextMonth = A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Months, 1, firstDayOfTheMonth);
	var dayViews = A2(
		$elm$core$List$map,
		function (date) {
			return A3($author$project$Calendar$dayTile, currentDate, date, onSelectDay);
		},
		A4($justinmimbs$date$Date$range, $justinmimbs$date$Date$Day, 1, firstDayOfTheMonth, firstDayOfNextMonth));
	var weeks = A2(
		$elm$core$List$map,
		$mdgriffith$elm_ui$Element$row(
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						...
						onChange: $author$project$Main$DidInputName,
						...
						[$mdgriffith$elm_ui$Element$Font$alignRight]),
					{
						...
						onChange: $author$project$Main$DidInputCount,
						placeholder: $elm$core$Maybe$Nothing,
					...
					_List_fromArray(
						[
							...
							{currentDate: model.tuppingDate, currentMonth: model.currentMonth, currentYear: model.currentYear, onClickNextMonth: $author$project$Main$ClickedNextMonth, onClickPreviousMonth: $author$project$Main$ClickedPreviousMonth, onSelectDay: $author$project$Main$DidChangeTuppingDate}),
							A2(
							...
							{
								label: $mdgriffith$elm_ui$Element$text('Nombre de cycles'),
								onChange: $author$project$Main$DidChangeTuppingDuration,
								options: _List_fromArray(
									[$author$project$Batch$OneCycle, $author$project$Batch$OneCycleAndAHalf, $author$project$Batch$TwoCycles, $author$project$Batch$ThreeCycles]),
								selected: $elm$core$Maybe$Just(model.tuppingDuration),
								toString: $author$project$Batch$tuppingDurationToString
							})
						])),
					A2(
					$author$project$Main$select,
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Sevrage'),
						onChange: $author$project$Main$DidInputWeaning,
						options: _List_fromArray(
							[$author$project$Batch$SixtyDays, $author$project$Batch$SeventyDays, $author$project$Batch$EightyDays, $author$project$Batch$NinetyDays]),
						selected: $elm$core$Maybe$Just(model.weaning),
						toString: function (weaning) {
							return $elm$core$String$fromInt(
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Vente'),
						onChange: $author$project$Main$DidInputSelling,
						options: _List_fromArray(
							[$author$project$Batch$ThreeMonths, $author$project$Batch$FourMonths, $author$project$Batch$FiveMonths, $author$project$Batch$SixMonths, $author$project$Batch$SevenMonths, $author$project$Batch$EightMonths]),
						selected: $elm$core$Maybe$Just(model.selling),
						toString: $author$project$Batch$sellingToString
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_List_Nil,
					{
						...
						onPress: $elm$core$Maybe$Just($author$project$Main$ClickedGenerate)
					}),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
					...
					A2($elm$core$List$map, $author$project$Main$eventView, model.events))
				])));
};
